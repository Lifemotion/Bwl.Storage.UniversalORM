...
Public Class ReflectionToolsBlob
        ...
        If obj IsNot Nothing Then
            ...
            Else
                ...
                For Each item In members.Where(Function(m)
                    ...
                    Dim value = GetMemberValueBLOB(item.Name, obj)
    ...
    Shared Sub SetMemberValueBLOB(fieldPath As String, obj As Object, value As Object)
            ...
            If members.Any Then
                For Each member In members
                    If member.MemberType = MemberTypes.Property Then
                        ...
                        End If
                        SetMemberValueBLOB(path, obj, value)
                    End If
    ...
    Private Shared Function GetMemberValueBLOB(fieldPath As String, obj As Object) As Object
        Dim fieldParts = fieldPath.Split("."c)
        ...
        Else
            ...
            For Each member In members
                If member.MemberType = MemberTypes.Property Then
                    ...
                    Dim nested = GetMemberValueBLOB(path, value)
                    Return nested
                End If
                If member.MemberType = MemberTypes.Field Then
